package dev.learn.ai.workshop.prompt;
...
public class ArticleController {
    ...
    public ArticleController(@Qualifier("openAPIChatClient") ChatClient chatClient){
    ...
    public String newPost(@RequestParam(value = "topic", defaultValue = "JDK Virtual Threads") String topic){
        var systemInstructions = """
                ...
                1. Length & Pupose: Generate 500 word blog posts that inform and engage general audiences.
                2. Structure:
